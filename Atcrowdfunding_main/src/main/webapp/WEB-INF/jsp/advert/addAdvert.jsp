...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="#">众筹平台 - 用户添加</a></div>
        </div>
                ...
                <div class="panel-body">
                    <form id="advertForm" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" id="advpic" name="advpic" placeholder="请选择广告图片">
                        </div>
                        <button type="button" class="btn btn-success" id="saveBtn"><i class="glyphicon glyphicon-edit" ></i> 保存</button>
