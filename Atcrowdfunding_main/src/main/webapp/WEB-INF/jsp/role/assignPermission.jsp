...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="#">众筹平台 - 权限分配</a></div>
        </div>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <button id="assign_permission_btn" class="btn btn-success">分配许可</button>
                    <br><br>
...
<script type="text/javascript">
    $(function () {
        ...
        var setting = {
            ...
            async: {
                enable: true,
                url:"${APP_PATH}/role/loadPermission.do?roleId=${param.id}",
...
//        $.fn.zTree.init($("#treeDemo"), setting, d);
        ...
        //分配许可按钮事件
        $("#assign_permission_btn").on("click",function () {
            layer.confirm('确定分配许可？', {
                btn: ['确定','取消'] //按钮
            }, function(){
                assignPermission();
            });
        ...
        function assignPermission() {
            ...
            if(checkedNodes.length == 0){
                layer.msg("请至少选择一个许可进行分配",{time:1000});
                return false;
            }
