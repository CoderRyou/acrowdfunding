...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="#">众筹平台 - 角色修改</a></div>
        </div>
                ...
                <div class="panel-body">
                    <form role="form" id="add_user_form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fname" name="name" value="${role.name}" placeholder="请输入角色名称">
                        </div>
                        <button id="role_edit_btn" type="button" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> 修改</button>
...
<script type="text/javascript">
    ...
    $("#role_edit_btn").click(function (){
        var index = -1;
        layer.confirm('确定修改该角色？', {
            btn: ['确定','取消'] //按钮
        }, function(){
            $.ajax({
                url:"${APP_PATH}/role/doEditRole.do",
                type:"POST",
                data:{
                    "id":${role.id},
                    "name":$("#fname").val()
