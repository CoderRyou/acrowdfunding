...
<div class="container">
    ...
    <form id="loginForm" method="post" class="form-signin" role="form">
        ...
        <div class="form-group has-success has-feedback">
            <input type="text" class="form-control" id="fuserpswd" name="userpswd" value="123" placeholder="请输入登录密码" style="margin-top:10px;">
...
//        $("#loginForm").submit();
        ...
        $.ajax({
            ...
            success:function (data) {
                layer.close(index);
                if(data.success){
                    if(data.datas.type == "user"){
                        window.location.href = "main.htm";
                    }else{
                        window.location.href = "member/index.htm";
                    }
                }else {
                    layer.msg('用户名或者密码错误！请重试！');
                    $("#loginForm")[0].reset();
                }
            },
            error:function () {
