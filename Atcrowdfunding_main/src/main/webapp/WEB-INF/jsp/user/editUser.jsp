            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" id="edit_user_form">
                        ...
                        <button type="button" class="btn btn-success" id="user_edit_btn"><i class="glyphicon glyphicon-edit"></i> 修改</button>
...
<script type="text/javascript">
    ...
    $("#user_edit_btn").click(function (){
        var index = -1;
        layer.confirm('确定修改该用户？', {
            btn: ['确定','取消'] //按钮
        }, function(){
            $.ajax({
                url:"${APP_PATH}/user/doEditUser.do?_method=PUT",
                type:"POST",
                data:{
                    "id":"${user.id}",
