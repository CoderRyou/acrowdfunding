...
<div class="container theme-showcase" role="main">
    ...
    <form id="emailForm" role="form" style="margin-top:20px;">
        <div class="form-group">
            ...
            <input id="email" name="email" type="text" class="form-control" placeholder="请输入用于接收验证码的邮箱地址">
        </div>
    ...
    $("#nextBtn").click(function () {
        $.ajax({
            ...
            beforeSubmit:function () {
                loadingIndex = layer.msg("邮件发送中，请稍等！",{icon:6});
                return true;//必须返回true，否则，请求终止
            },
            success:function (result) {
                layer.close(loadingIndex);
                if(result.success){
                    layer.msg("邮件发送成功，请确认！",{time:1000,icon:6});
            ...
            error:function () {
                layer.msg("邮件发送出错",{time:1000,icon:5});
            }
        });
    });
</script>
