                ...
                <div class="panel-body">
                    <form role="form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fname" name="name" placeholder="输入许可名称" value="${permission.name}">
                        </div>
                        <div class="form-group">
                            <label for="furl">url</label>
                            <input type="text" class="form-control" id="furl" placeholder="输入url" value="${permission.url}">
                        </div>
                        <button type="button" id="permission_edit_btn" class="btn btn-success"><i class="glyphicon glyphicon-edit" ></i> 保存</button>
...
<script type="text/javascript">
    ...
    $("#permission_edit_btn").click(function (){
        var index = -1;
        layer.confirm('确定修改该许可？', {
            btn: ['确定','取消'] //按钮
        }, function(){
            $.ajax({
                url:"${APP_PATH}/permission/doEditPermission.do",
                type:"POST",
                data:{
                    "id":${permission.id},
                    "name":$("#fname").val(),
